...
class Parser:
    ...
    def __init__(self,
        ...
        extension_command_data_filename = f"{EXTENSION_COMMAND_DATA_FILENAME}.{Recorder.extension()}"
        ...
        context_data_filename = f"{CONTEXT_DATA_FILENAME}.{Recorder.extension()}"
    ...
    def read_packet(self, buf: RawIOBase):
        ...
        if (payload_size != expected_size):
            ...
            print(f"unexpected packet type - {packet_type}:{indicators}:{len(payload)}")
